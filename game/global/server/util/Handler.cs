...
public static class PacketHandler
{
    public static void InitHandler(this MPacketHandler hook)
    {
        ...
        var callableAttributes =
            ...
            where m.GetCustomAttribute<Callable>() != null
            select new { method = m, attribute = m.GetCustomAttribute<Callable>() };
...
// Boilerplate! Bolilerplate everywhere! We love boilerplate!
